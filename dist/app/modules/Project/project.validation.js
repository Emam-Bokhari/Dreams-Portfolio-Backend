...
const createProjectValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        keyFeatures: zod_1.z.array(zod_1.z.string().min(5, 'Each key feature must be at least 5 characters long')),
        ...
        collaborationAndTeamWork: zod_1.z.string().optional(),
        ...
        versionControlAndDeployment: zod_1.z.string().optional(),
        projectTimeline: zod_1.z.string().optional(),
        caseStudy: zod_1.z.string().optional(),
...
const updateProjectValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        technologiesUsed: zod_1.z
            .array(zod_1.z.string().min(3, 'Technology name must be at least 3 characters long'))
            .optional(),
        challengesFaced: zod_1.z.string().optional(),
        solution: zod_1.z.string().optional(),
        keyFeatures: zod_1.z
