...
const getDashboardDataController = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield dashboard_service_1.DashboardServices.getDashboardData();
