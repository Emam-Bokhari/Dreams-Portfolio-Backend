...
const createProjectValidationSchema = z.object({
    body: z.object({
        ...
        technologiesUsed: z.array(z.string().min(3, "Technology name must be at least 3 characters long")),
        challengesFaced: z.string().optional(),
        solution: z.string().optional(),
        keyFeatures: z.array(z.string().min(5, "Each key feature must be at least 5 characters long")),
        liveLink: z.string(),
...
const updateProjectValidationSchema = z.object({
    body: z.object({
        ...
        description: z.string().min(20, "Description must be at least 20 characters long").max(1000, "Description must not exceed 1000 characters").optional(),
        client: z.string().optional(),
        technologiesUsed: z.array(z.string().min(3, "Technology name must be at least 3 characters long")).optional(),
        challengesFaced: z.string().optional(),
        solution: z.string().optional(),
        keyFeatures: z.array(z.string().min(5, "Each key feature must be at least 5 characters long")).optional(),
